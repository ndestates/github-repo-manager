...
# Cleanup Script for Inactive Repositories Since 2023
# Deletes repositories not updated since 2023-12-31
...
CANDIDATES_FILE="inactive_2024_candidates.txt"
...
echo "Inactive Repositories Since 2023 Cleanup"
echo "========================================"
echo ""
...
echo "Inactive 2024 cleanup complete."